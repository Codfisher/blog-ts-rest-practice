...
const tasksOption: Option[] = [
  {
    ...
    key: 'collection-data',
    sourcePath: '../src/collection-data',
    targetPath:
      '../../../blueprint-templates/shared-collection/__kebabCase_name__',
  },
  {
    name: 'single-data',
    key: 'single-data',
    sourcePath: '../src/single-data',
    targetPath:
      '../../../blueprint-templates/shared-single/__kebabCase_name__',
  },
]
